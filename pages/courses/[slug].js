        ...
        <div className="max-w-5xl mx-auto">
          ...
          {courseState === "activated" && (
            <Message type="success">
              We wishes happy watching of the course.
            </Message>
          )}
          {courseState === "deactivated" && (
            <Message type="danger">
...
// Specify how many pages we would like to create and what parameters we want to pass to the pages.
...
// Specify the props that should be passed to the component by given course slug.
